...
public class Game
{
    ...
    private HashMap<String, command_function> functions;
    private database data;

    private Help help;
    private Go_room go_room;
    private Back_room back_room;
    private Quit_room quit_room;
    private Take_room take_room;
    private Look_room look_room;
    private Look_items look_items;
    private Drop_items drop_items;
    private Eat_cookie eat_cookie;
    private Save save;
    ...
    public void create_function()
    {
        help = new Help();
        go_room = new Go_room();
        quit_room = new Quit_room();
        back_room = new Back_room();
        look_room = new Look_room();
        look_items = new Look_items();
        take_room = new Take_room();
        drop_items = new Drop_items();
        eat_cookie = new Eat_cookie();
        save = new Save();
        functions.put("help", help);
        functions.put("go", go_room);
        functions.put("quit", quit_room);
        functions.put("back", back_room);
        functions.put("look", look_room);
        functions.put("items", look_items);
        functions.put("take", take_room);
        functions.put("drop", drop_items);
        functions.put("eat", eat_cookie);
    ...
    {
        command_function function = functions.get(command.getCommandWord());
        if(function != null)
    ...
    class Save implements command_function{
        @Override
        /**
         * 玩家信息保存
         */
    ...
    class Help implements command_function {
        /**
    ...
    class Go_room implements command_function {
        /**
    ...
    class Back_room implements command_function {
        /**
    ...
    class Quit_room implements command_function {
        /**
    ...
    class Look_room implements command_function {
        /**
    ...
    class Look_items implements command_function {
        /**
    ...
    class Take_room implements command_function {
        /**
    ...
    class Drop_items implements command_function {
        /**
    ...
    class Eat_cookie implements command_function {
        /**
